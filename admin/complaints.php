...
if(isset($_GET['del']))
{
      ...
      $_SESSION['delmsg']="Operation successful. Msg deleted!";
							...
							{?>
								...
								<div class="panel">
									<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
										...
										<?php $query=mysqli_query($con,"SELECT * from complaints");
										$cnt=1;
										...
										?>									
											<tr>
												...
												<td>
													<a href="manage-users.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to remove this complaint?')"><i class="icon-trash"></i></a></td>
