...
if(isset($_GET['del']))
{
      ...
      $_SESSION['delmsg']="User Removed deleted !!";
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									?>									
										<tr>
											...
											<td>
												<a href="manage-users.php?id=<?php echo $row['user_id']?>&del=delete" onClick="return confirm('Are you sure you want to remove this user?')"><i class="icon-remove-sign"></i></a>
											</td>
