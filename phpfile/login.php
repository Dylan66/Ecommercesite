...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"INSERT INTO users(name, email, user_type, contactno, password) values('$name','$email','$userType','$contactno','$password')");
	if($query)
	{
...
if(isset($_POST['login']))
{
	...
	if($row > 0)
	{
		...
		//direct users based on their roles
		switch ($usertype) {
			case 'Customer':
			...
			case 'Tenant':
				$extra="tenants/index.php";
				$_SESSION['tlogin']=$_POST['email'];
				$_SESSION['tid']=$row['user_id'];
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">sign in</h4>
	<p class="text-info">Hello, Welcome to your account.</p>
...
<div class="form-group">
	    	<label class="info-title" for="fullname">Customer Name / Tenant Name <span>*</span></label>
		...
		<div class="form-group">
	  	...
	  	<h5 class="text-info text-capitalize"><b>User Type</b></h5>
	  	<div class="form-group">	
		    <input type="radio" name="userType" value="Customer" checked="checked"> Customer &emsp;
