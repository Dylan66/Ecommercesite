...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"UPDATE users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where user_id='".$_SESSION['id']."'");
		if($query)
		{
	    ...
	    <div class="panel-body">
			<div class="row">		
				...
				<?php
					...
					<form id="shipaddress_form" class="register-form" role="form">
