...
<head>
	...
	<title>Tenant | Manage Products</title>
							...
							<div class="module-body table">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<?php 
										...
										$query = mysqli_query($con,"SELECT products.*,category.categoryName,subcategory.subcategory from products JOIN category ON category.id=products.category JOIN subcategory ON subcategory.id=products.subCategory WHERE tenant_ID = '$myProducts'");
										$cnt=1;
										if ($query->num_rows) 
										{
										?>
