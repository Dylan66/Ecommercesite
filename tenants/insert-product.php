...
if(isset($_POST['submit']))
{
	...
	$sql = mysqli_query($con,"INSERT into products(tenant_ID, category, subCategory, productName, productCompany, productPrice, productDescription, shippingCharge, productAvailability, productImage1, productImage2, productImage3, productPriceBeforeDiscount) 
			VALUES('$tenant_ID','$category','$subcat','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<head>
	...
	<title>Tenant | Insert Product</title>
...
<br>
<!-- <div class="control-group"> -->
<!-- <label class="control-label" for="basicinput">Tenant</label> -->
<!-- <div class="controls"> -->
<input type="hidden" name="tenant_ID" class="span8 tip" value="<?php echo($cus = $_SESSION['tid']); ?>" readonly required>
<!-- </div> -->
<!-- </div> -->
